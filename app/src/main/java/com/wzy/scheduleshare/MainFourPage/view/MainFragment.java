...
import com.wzy.scheduleshare.MainFourPage.adapter.MainLHorizontalAdapter;
...
import com.wzy.scheduleshare.MainFourPage.presenter.impl.MainPagePresenterImpl;
...
public class MainFragment extends BaseFragment<MainPagePresenter> implements MainPagePresenter.View {
    ...
    private void initCollect() {
        ...
        mMainPageHappenRecycleView.setNestedScrollingEnabled(false);
    ...
    public void onRefreshCollectList(RefreshCollectList event) {
        collect_list.remove(event.getDetail());
