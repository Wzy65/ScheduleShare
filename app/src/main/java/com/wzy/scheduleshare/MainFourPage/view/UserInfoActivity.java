...
import com.wzy.scheduleshare.MainFourPage.presenter.impl.UserInfoPresenterImpl;
import com.wzy.scheduleshare.MainFourPage.presenter.inter.UserInfoPresenter;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.userinfo_enter_personalPage:
                Intent intent = new Intent(UserInfoActivity.this, OtherPageActivity.class);
                intent.putExtra(OtherPageActivity.INTENT_TO_OTHEPAGE, mUser);
