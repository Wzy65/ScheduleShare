...
import com.wzy.scheduleshare.MainFourPage.adapter.CommentsListAdapter;
import com.wzy.scheduleshare.MainFourPage.modle.Comment;
import com.wzy.scheduleshare.MainFourPage.modle.ScheduleDetail;
import com.wzy.scheduleshare.MainFourPage.presenter.impl.ShareScheduleDetailPresenterImpl;
...
import com.wzy.scheduleshare.base.Utils.RecyclerViewDivider;
...
public class ShareScheduleDetailActivity extends BaseActivity<ShareScheduleDetailPresenter> implements ShareScheduleDetailPresenter.View {
    ...
    public void initView() {
        ...
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                ...
                mPresenter.checkCollectStatus(mDetail);
    ...
    * */
    ...
    @OnClick({R.id.share_schedule_detail_comment_send, R.id.share_schedule_detail_comment, R.id.share_schedule_detail_userIcon})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.share_schedule_detail_comment:
                ...
                mShareScheduleDetailCommentLayout.setVisibility(View.VISIBLE);
                break;
            case R.id.share_schedule_detail_userIcon:
                if (!mDetail.getAuth().getObjectId().equals(BmobUser.getCurrentUser(User.class).getObjectId())) {
                    Intent intent = new Intent(ShareScheduleDetailActivity.this, UserInfoActivity.class);
                    intent.putExtra(UserInfoActivity.UserInfoKey, mDetail.getAuth());
                    intent.putExtra(UserInfoActivity.ShowAddFriendKey, true);
                    startActivity(intent);
                }
                break;
