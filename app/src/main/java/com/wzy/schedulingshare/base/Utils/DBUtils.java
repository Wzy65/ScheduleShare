...
public class DBUtils {
    ...
    public void insert2Local(ScheduleDetail detail) {
        ...
        long id = mDatabase.replace(ScheduleDetailDBHelper.LocalDetailTable, null, values);
    ...
    public void deleteTemp(String auth) {
        mDatabase.delete(ScheduleDetailDBHelper.TempDetailTable, "auth=?", new String[]{auth});
