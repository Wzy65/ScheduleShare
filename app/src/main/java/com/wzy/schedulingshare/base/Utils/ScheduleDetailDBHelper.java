...
public class ScheduleDetailDBHelper extends SQLiteOpenHelper {
    ...
    public static final String OfflineDetailTable = "OfflineDetailTable";  //离线信息
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table if not exists " + LocalDetailTable + "(" +
                "objectId text primary key," +  //唯一键，对应Bomb云
                "title text ," +   //标题
                "content text ," +   //图文消息内容
                "updateAt text ," +  //更新日期
                "startAt text ," +   //事件开始日期
        ...
        /*创建离线状态下保存的表*/
        db.execSQL("create table if not exists " + OfflineDetailTable + "(" +
